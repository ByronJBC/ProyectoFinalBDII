...
<head runat="server">
    ...
    <title>Añadir Cliente - Muebles los Alpes</title>
</head>
<body>
    <form runat="server">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <asp:TextBox runat="server" ID="txtProfesion" class="form-control" placeholder="Programador" required="required" ></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3 mb-3">
