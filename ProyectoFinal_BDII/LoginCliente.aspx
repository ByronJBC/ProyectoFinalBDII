<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LoginCliente.aspx.vb" Inherits="ProyectoFinal_BDII.Login" %>
...
<body>
    ...
    <div class="bg order-1 order-md-2" style="background-image: url('assets/img/login-bgCli.jpg');">
    </div>
